...
namespace drug_lib::data::objects::medicaments
{
    ...
    TEST(PrescriptionDrugTest, ParameterizedConstructorWithJson)
    {
        ...
        properties[PrescriptionDrug::names_of_json_fields::description] = "Take twice daily";
    ...
    TEST(PrescriptionDrugTest, GetInfo)
    {
        ...
        EXPECT_EQ(info[PrescriptionDrug::names_of_json_fields::description].asString(), "Use only as directed");
    }

    TEST(PrescriptionDrugTest, SetInfo)
    {
        Json::Value properties;
        properties[PrescriptionDrug::names_of_json_fields::description] = "Take with food";
