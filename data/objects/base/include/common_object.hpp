...
namespace drug_lib::data
{
	namespace objects
	{
		...
		public:
			...
			/**
			 *
			 * @param id Unique main id for record. This is a reason why is primary is marked true
			 */
	...
	[[nodiscard]] inline std::unique_ptr<common::database::Field<Json::Value>> PropertyCollection::make_properties_field() const noexcept
	{
		Json::Value result;
